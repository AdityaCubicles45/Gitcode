    ...
    return(
        <div className="meeting">
            ...
            {!isJoined && <div className = "meeting-input">
                <input className='input-area meet' onChange={handleRoom} placeholder='Create Meet'></input>
                <input className='input-area meet' onChange={handleRoom} placeholder='Connect Meet'></input>
